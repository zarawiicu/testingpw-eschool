...
Tiada Tuhan selain Allah`;
  ...
  // Klik tombol "Unggah" jika memang dibutuhkan
  await page.getByRole("button", { name: "Unggah" }).click();
...
test('Hapus Pengumuman', async({page}) => {
  ...
  await page.getByRole('button', {name: 'Refresh' }).click();
  console.log('melakukan refres tabel');
  await page.getByRole('row', { name: '1 Sholatlah Jumat, Update' }).locator('#dropdownMenuButton').click();
